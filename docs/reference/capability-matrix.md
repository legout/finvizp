...
This document mirrors [`src/finvizp/capabilities.json`](../../src/finvizp/capabilities.json)
...
- **Inventory date:** 2026-08-27 (frozen; see the
  [public-surface inventory](../research/public-surface-inventory.md) and the
  [`finvizfinance` audit](../research/finvizfinance-audit.md)).
