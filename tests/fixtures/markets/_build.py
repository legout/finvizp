...
CRYPTO_ROWS = [
    ...
    ("SUI", "Sui", "1.8120", ["0.08%", "-0.21%", "2.10%", "2.10%", "11.40%", "5.60%", "14.80%", "-5.40%", "-22.10%"]),
    ("LINK", "Chainlink", "13.4400", ["0.10%", "-0.13%", "2.80%", "2.80%", "14.90%", "8.30%", "17.60%", "-7.20%", "-26.40%"]),
    ("APT", "Aptos", "3.2100", ["0.04%", "-0.10%", "1.60%", "1.60%", "9.80%", "3.90%", "8.70%", "-3.80%", "-19.30%"]),
    ("ETH", "Ethereum", "2810.5500", ["0.07%", "-0.12%", "1.70%", "1.70%", "15.10%", "6.20%", "12.40%", "-1.90%", "-12.60%"]),
    ("NEAR", "NEAR Protocol", "2.4700", ["0.06%", "-0.16%", "2.20%", "2.20%", "12.90%", "6.80%", "15.10%", "-6.60%", "-25.20%"]),
    ("AAVE", "Aave", "128.1600", ["0.14%", "-0.22%", "3.90%", "3.90%", "21.60%", "12.10%", "24.90%", "-9.40%", "-33.80%"]),
    ("ADA", "Cardano", "0.4120", ["0.02%", "-0.06%", "1.00%", "1.00%", "7.40%", "2.10%", "5.60%", "-4.80%", "-20.20%"]),
    ("AVAX", "Avalanche", "15.8700", ["0.05%", "-0.14%", "1.80%", "1.80%", "10.20%", "4.40%", "10.60%", "-5.10%", "-21.70%"]),
    ("TAO", "Bittensor", "201.3300", ["0.11%", "-0.18%", "3.20%", "3.20%", "17.70%", "9.80%", "20.40%", "-8.10%", "-28.90%"]),
    ("XRP", "Ripple", "2.0500", ["0.03%", "-0.08%", "1.30%", "1.30%", "8.60%", "3.20%", "7.80%", "-2.40%", "-15.10%"]),
    ("LTC", "Litecoin", "87.6400", ["0.04%", "-0.07%", "1.20%", "1.20%", "7.90%", "2.80%", "6.90%", "-2.90%", "-14.40%"]),
    ("SHIB", "Shiba Inu", "0.0000092", ["0.07%", "-0.09%", "1.50%", "1.50%", "9.10%", "3.60%", "8.20%", "-3.60%", "-16.80%"]),
    ...
    ("GRAM", "Gram", "0.0213", ["0.12%", "-0.24%", "4.10%", "4.10%", "25.30%", "15.40%", "29.60%", "-11.20%", "-38.40%"]),
    ("WLFI", "World Liberty Financial", "0.1340", ["0.09%", "-0.19%", "3.60%", "3.60%", "22.10%", "13.80%", "26.20%", "-10.40%", "-35.10%"]),
    ("BTC", "Bitcoin", "84520.1000", ["0.04%", "-0.09%", "1.10%", "1.10%", "12.30%", "4.10%", "9.90%", "-3.20%", "-18.40%"]),
    ("OP", "Optimism", "0.6820", ["0.05%", "-0.12%", "1.90%", "1.90%", "10.60%", "4.90%", "11.40%", "-5.60%", "-23.10%"]),
    ("HBAR", "Hedera", "0.1480", ["0.03%", "-0.08%", "1.20%", "1.20%", "7.60%", "2.60%", "6.40%", "-3.10%", "-15.90%"]),
    ("BNB", "Binance Coin", "602.3100", ["0.06%", "-0.10%", "1.40%", "1.40%", "8.90%", "3.40%", "7.50%", "-2.60%", "-13.70%"]),
    ("XLM", "Stellar", "0.2340", ["0.04%", "-0.09%", "1.30%", "1.30%", "8.10%", "3.00%", "7.10%", "-3.40%", "-16.20%"]),
    ("S", "Sonic", "0.1890", ["0.08%", "-0.17%", "2.60%", "2.60%", "15.80%", "8.70%", "18.90%", "-7.80%", "-27.30%"]),
    ("ATOM", "Cosmos", "3.0400", ["0.05%", "-0.11%", "1.70%", "1.70%", "9.40%", "4.20%", "9.80%", "-4.40%", "-20.80%"]),
    ("TRX", "TRON", "0.2760", ["0.02%", "-0.05%", "0.90%", "0.90%", "6.80%", "1.90%", "5.10%", "-2.10%", "-12.40%"]),
    ("ICP", "Internet Computer", "4.5700", ["0.06%", "-0.13%", "2.00%", "2.00%", "11.10%", "5.20%", "12.70%", "-5.90%", "-24.60%"]),
    ("TRUMP", "Trump", "8.4100", ["0.10%", "-0.20%", "3.80%", "3.80%", "23.40%", "14.60%", "27.80%", "-10.90%", "-36.20%"]),
    ("POL", "Polygon", "0.1980", ["0.07%", "-0.15%", "2.30%", "2.30%", "13.60%", "7.10%", "16.30%", "-6.90%", "-26.10%"]),
]
...
def _tile_from_last(ticker: str, last: float, prev: float, high: float,
                    low: float, spark: list[float]) -> dict:
...
AUDUSD_SPARK = [
    0.71953, 0.71959, 0.71961, 0.71958, 0.71956,
    0.71948, 0.71949, 0.71951, 0.71947, 0.71953,
]
